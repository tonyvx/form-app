...
export const ShowForm = ({ formData, open, setOpen }) => {
    ...
    return <Dialog ref={ref} onClose={handleClose} aria-labelledby="customized-dialog-title" open={open} maxWidth={"lg"}>
        ...
        <DialogContent dividers>
            ...
            <Grid container>
                <Grid item xs={6} align="center"></Grid><Grid item xs={6} align="center"><img src={formData.sign} width="50%" height="50%" alt="Lessor's Signature"/></Grid>
        ...
        <DialogActions>
            <Button onClick={() => window.print("test.pdf")}>Generate PDF</Button>
        </DialogActions>
